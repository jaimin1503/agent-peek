...
export default function App() {
  ...
  /**
   * Expansion is derived, not scheduled. Hover is you asking; attention is the
   * one moment the app exists for, so it opens itself and closes again when the
   * session stops waiting — no timers to get wrong.
   */
  const expanded = hovering || attention;
  ...
  return (
    ...
    // shadow, and widens the hover target of a 28px-tall capsule.
    <div
      ref={shell}
